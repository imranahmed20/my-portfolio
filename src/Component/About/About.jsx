            ...
            <div className='banner container mb-5' id="about">
                ...
                <div className='row row-cols-1 row-cols-md-2 g-4'>
                    <div className='col' data-aos="fade-right">
                        <h4 className='fw-bold mb-4'><span>Name:</span>  Md.Imran Ahmed</h4>
